...
const RentModal = () => {
    ...
    let bodyContent = (
        <div className="flex text-black flex-col gap-8 mt-4">
            <Heading
    ...
    if (step === STEPS.INFO) {
        bodyContent = (
            <div className="flex flex-col gap-8 text-black">
                ...
                <hr/>
                <Counter title="Rooms" subtitle="How many bathrooms do you have?" value={bathroomCount} onChange={(value)=> setCustomValue("bathroomCount",value)}/>
            </div>
        )
    }
